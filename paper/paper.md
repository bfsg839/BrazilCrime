...
![Figure 1: Criminal incidents recorded in the state of São Paulo, January 2015 to December 2024, by crime type. Source: Elaborated by the authors with the `BrazilCrime` package.\label{fig:incidents}](fig1.png)
...
![Figure 2: Observed values through December 2024 and forecasts of intentional homicides in the city of São Paulo, January 2025 to December 2025. Elaborated by the authors with the `BrazilCrime` package.\label{fig:forecast}](fig2.png)
